...
CREATE TABLE [People_Marriage](
	...
	MaCDVo varchar(10) FOREIGN KEY REFERENCES [Citizens](MaCD) NOT NULL,
...
(3, 3, N'Ung thư', '2022-03-15', GETDATE(), NULL),
(5, 5, N'Tai nạn giao thông', '2022-04-20', GETDATE(), NULL);
...
VALUES
    (N'Mail 1', '2022-01-01', 'CD0001', 'CD0002', N'Nội dung mail 1'),
    (N'Mail 2', '2022-02-05', 'CD0001', 'CD0004', N'Nội dung mail 2'),
    (N'Mail 3', '2022-03-10', 'CD0001', 'CD0006', N'Nội dung mail 3'),
    (N'Mail 4', '2022-04-15', 'CD0001', 'CD0008', N'Nội dung mail 4'),
    (N'Mail 5', '2022-05-20', 'CD0001', 'CD0010', N'Nội dung mail 5'),
    (N'Mail 6', '2022-06-25', 'CD0001', 'CD0012', N'Nội dung mail 6'),
    (N'Mail 7', '2022-07-30', 'CD0001', 'CD0014', N'Nội dung mail 7'),
    (N'Mail 8', '2022-08-04', 'CD0001', 'CD0016', N'Nội dung mail 8'),
    (N'Mail 9', '2022-09-09', 'CD0001', 'CD0018', N'Nội dung mail 9'),
    (N'Mail 10', '2022-10-14', 'CD0001', 'CD0020', N'Nội dung mail 10'),
    (N'Mail 11', '2022-11-19', 'CD0001', 'CD0022', N'Nội dung mail 11'),
    (N'Mail 12', '2022-12-24', 'CD0001', 'CD0024', N'Nội dung mail 12'),
    (N'Mail 13', '2023-01-29', 'CD0001', 'CD0026', N'Nội dung mail 13'),
    (N'Mail 14', '2023-03-05', 'CD0001', 'CD0028', N'Nội dung mail 14'),
    (N'Mail 15', '2023-04-10', 'CD0001', 'CD0030', N'Nội dung mail 15'),
    (N'Mail 16', '2023-05-15', 'CD0001', 'CD0032', N'Nội dung mail 16'),
    (N'Mail 17', '2023-06-20', 'CD0001', 'CD0034', N'Nội dung mail 17'),
    (N'Mail 18', '2023-07-25', 'CD0001', 'CD0036', N'Nội dung mail 18'),
    (N'Mail 19', '2023-08-30', 'CD0001', 'CD0038', N'Nội dung mail 19'),
    (N'Mail 20', '2023-10-04', 'CD0001', 'CD0040', N'Nội dung mail 20'),
    (N'Mail 21', '2023-10-09', 'CD0002', 'CD0001', N'Nội dung mail 21'),
    (N'Mail 22', '2023-09-04', 'CD0004', 'CD0001', N'Nội dung mail 22'),
    (N'Mail 23', '2023-08-01', 'CD0006', 'CD0001', N'Nội dung mail 23'),
    (N'Mail 24', '2023-07-01', 'CD0008', 'CD0001', N'Nội dung mail 24'),
    (N'Mail 25', '2023-06-05', 'CD0010', 'CD0001', N'Nội dung mail 25'),
    (N'Mail 26', '2023-05-08', 'CD0012', 'CD0001', N'Nội dung mail 26'),
    (N'Mail 27', '2023-04-02', 'CD0014', 'CD0001', N'Nội dung mail 27'),
    (N'Mail 28', '2023-03-01', 'CD0016', 'CD0001', N'Nội dung mail 28'),
    (N'Mail 29', '2023-02-02', 'CD0018', 'CD0001', N'Nội dung mail 29'),
    (N'Mail 30', '2023-01-06', 'CD0020', 'CD0001', N'Nội dung mail 30'),
    (N'Mail 31', '2022-12-10', 'CD0022', 'CD0001', N'Nội dung mail 31'),
    (N'Mail 32', '2022-11-14', 'CD0024', 'CD0001', N'Nội dung mail 32'),
    (N'Mail 33', '2022-10-19', 'CD0026', 'CD0001', N'Nội dung mail 33'),
    (N'Mail 34', '2022-09-23', 'CD0028', 'CD0001', N'Nội dung mail 34'),
    (N'Mail 35', '2022-08-27', 'CD0030', 'CD0001', N'Nội dung mail 35'),
    (N'Mail 36', '2022-07-31', 'CD0032', 'CD0001', N'Nội dung mail 36'),
    (N'Mail 37', '2022-07-03', 'CD0034', 'CD0001', N'Nội dung mail 37'),
    (N'Mail 38', '2022-06-05', 'CD0036', 'CD0001', N'Nội dung mail 38'),
    (N'Mail 39', '2022-05-09', 'CD0038', 'CD0001', N'Nội dung mail 39'),
    (N'Mail 40', '2022-04-13', 'CD0040', 'CD0001', N'Nội dung mail 40');


INSERT INTO Temporarily_Absent (MaCD, MaCCCD, Tinh, Huyen, Xa, LyDo, thoi_gian_bat_dau, thoi_gian_ket_thuc)
VALUES
  ('CD0001', 'CCCD001', N'Kon Tum', N'Đắk Hà', N'Hà Mòn', N'Học', '2023-05-01', '2023-05-07'),
  ('CD0002', 'CCCD002', N'Bình Thuận', N'Hàm Thuận Bắc', N'Phước Bình', N'Công tác', '2023-05-02', '2023-05-08'),
  ('CD0003', 'CCCD003', N'Tiền Giang', N'Cái Bè', N'Mỹ Thanh', N'Đi công việc', '2023-05-03', '2023-05-09'),
  ('CD0004', 'CCCD004', N'Quảng Bình', N'Đồng Hới', N'Đức Ninh', N'Du lịch', '2023-05-04', '2023-05-10'),
  ('CD0005', 'CCCD005', N'Hải Phòng', N'Hồng Bàng', N'Hà Khẩu', N'Công tác', '2023-05-05', '2023-05-11'),
  ('CD0006', 'CCCD006', N'Đồng Nai', N'Tân Phú', N'Tân Hòa', N'Học', '2023-05-06', '2023-05-12'),
  ('CD0007', 'CCCD007', N'Lâm Đồng', N'Đà Lạt', N'Liên Nghĩa', N'Du lịch', '2023-05-07', '2023-05-13'),
  ('CD0008', 'CCCD008', N'Ninh Bình', N'Tam Điệp', N'Yên Mạc', N'Đi công việc', '2023-05-08', '2023-05-14'),
  ('CD0009', 'CCCD009', N'Hà Tĩnh', N'Kỳ Anh', N'Kỳ Long', N'Du lịch', '2023-05-09', '2023-05-15'),
  ('CD0010', 'CCCD010', N'Đắk Lắk', N'Buôn Ma Thuột', N'Ea Kao', N'Công tác', '2023-05-10', '2023-05-16');


INSERT INTO Temporarily_Staying (MaCD, MaCCCD, Tinh, Huyen, Xa, LyDo, thoi_gian_bat_dau)
VALUES
  ('CD0011', 'CCCD011', N'Kon Tum', N'Đắk Hà', N'Hà Mòn', N'Học', '2023-05-01'),
  ('CD0012', 'CCCD012', N'Bình Thuận', N'Hàm Thuận Bắc', N'Phước Bình', N'Công tác', '2023-05-02'),
  ('CD0013', 'CCCD013', N'Tiền Giang', N'Cái Bè', N'Mỹ Thanh', N'Đi công việc', '2023-05-03'),
  ('CD0014', 'CCCD014', N'Quảng Bình', N'Đồng Hới', N'Đức Ninh', N'Du lịch', '2023-05-04'),
  ('CD0015', 'CCCD015', N'Hải Phòng', N'Hồng Bàng', N'Hà Khẩu', N'Công tác', '2023-05-05'),
  ('CD0016', 'CCCD016', N'Đồng Nai', N'Tân Phú', N'Tân Hòa', N'Học', '2023-05-06'),
  ('CD0017', 'CCCD017', N'Lâm Đồng', N'Đà Lạt', N'Liên Nghĩa', N'Du lịch', '2023-05-07'),
  ('CD0018', 'CCCD018', N'Ninh Bình', N'Tam Điệp', N'Yên Mạc', N'Đi công việc', '2023-05-08'),
  ('CD0019', 'CCCD019', N'Hà Tĩnh', N'Kỳ Anh', N'Kỳ Long', N'Du lịch', '2023-05-09'),
  ('CD0020', 'CCCD020', N'Đắk Lắk', N'Buôn Ma Thuột', N'Ea Kao', N'Công tác', '2023-05-10');
