    ...
    public partial class fHonNhan : Form
    {
        ...
        private void fHonNhan_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    LoadDataGrid();
                    cbMaCDNam.DataSource = CitizenDAO.Instance.IDMaleNotFamily();
                    cbMaCDNu.DataSource = CitizenDAO.Instance.IDFeMaleNotFamily();
        ...
        public void Fill(Cityzen Husband, Cityzen Wife)
        {
            try
            {
                ...
                dtpkNgaySinhNam.Value = BirthDAO.Instance.BirthByID(Husband.Macd).NgaySinh;
                dtpkNgaySinhNu.Value = BirthDAO.Instance.BirthByID(Wife.Macd).NgaySinh;

                tbNoiSinhNam.Text = BirthDAO.Instance.BirthByID(Husband.Macd).NoiSinh;
                tbNoiSinhNu.Text = BirthDAO.Instance.BirthByID(Wife.Macd).NoiSinh;
